...
declare -a listOfFiles=("git/.gitignore_global" "git/.gitconfig" "bash/.bashrc" "bash/.bash_profile" "bash/.bash_prompt" "others/.aliases" "others/.functions" "others/.exports" "others/.inputrc" "others/.wgetrc");
